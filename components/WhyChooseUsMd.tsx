...
const WhyChooseUsMd = () => {
  return (
    <div>
      <h1 className="mb-4 font-semibold md:text-4xl lg:mb-8 lg:text-4xl">
      ...
      <div className="lg:ml-8 lg:max-w-[75%]">
        <div>
          ...
          <p className="ml-4 text-lg leading-relaxed lg:ml-8">
            ...
            hair expert in Delhi. He is widely respected for his research and
            practice in the field of dermatology and is on the panel of several
            national dermatology forums.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="ml-4 text-lg leading-relaxed lg:ml-8">
            ...
            patients aware of the condition, prevention strategies, and
            effective treatment options. You will never walk out with a 5-minute
            consultation feeling lost! Dr. Varun is highly empathetic and is
            known to spend time and understand the your issues on a deep level.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="ml-4 text-lg leading-relaxed lg:ml-8">
            ...
            approved, and we have state-of-the-art technologies from the United
