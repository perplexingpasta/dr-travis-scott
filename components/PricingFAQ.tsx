...
const PricingFAQ = () => {
  ...
  return (
    <Accordion className="font-lexendDeca">
      ...
      >
        <div className="dark:text-white-100 text-gray-700">
          ...
          <span className="dark:text-purple font-bold">Essentials Suite</span>.
          ...
          <span className="dark:text-purple font-bold">Professional Suite</span>
          . It&apos;s the best fr.
        </div>
      </AccordionItem>
      <AccordionItem
      ...
      >
        <div className="dark:text-white-100 text-gray-700">
          In each tier we guarantee a particular number of appointments. An
          appointment is by definition a person who has shown interest in your
          ad and has booked a time and date for appointment to your clinic. This
          marks 1 appointment. After this, we ensure that the appointment is
          seen through and the person actually comes for paid consultation. That
          said, we only guarantee appointments if you follow everything as we
          say.
          <br />
          In the rare event that we can&apos;t hit our guaranteed appointment
          goal for the month, we&apos;ll keep working with you for free until we
          get you those guaranteed number of appointments.
        </div>
      </AccordionItem>
      <AccordionItem
        key="3"
      ...
      >
        <div className="dark:text-white-100 text-gray-700">
          ...
          <span className="dark:text-purple font-bold">Professional Suite</span>{" "}
          and weekly fo the{" "}
          <span className="dark:text-purple font-bold">Master Suite</span>. Here
