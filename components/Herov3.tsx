...
const Herov3 = () => {
  ...
  return (
    <div>
      ...
      <div className="absolute left-0 top-0 overflow-clip brightness-75 lg:hidden lg:h-[40rem] lg:w-full">
      ...
      <div className="mt-20 flex items-center justify-center px-4 md:ml-8 md:mt-16 lg:mx-auto lg:ml-60 lg:mt-0 lg:h-[40rem] lg:w-[75%] lg:flex-row lg:space-x-32">
        ...
        <div className="z-10 mx-auto text-3xl font-semibold md:text-5xl lg:text-6xl lg:leading-tight">
          <div className="ml-2 hidden font-normal text-black text-opacity-50 md:text-sm lg:-mb-16 lg:block lg:text-xl">
          ...
          <br />
          <div className="ml-2 hidden font-normal text-white text-opacity-75 md:mt-4 md:block md:max-w-[60%] md:text-lg lg:mt-8 lg:max-w-[40%] lg:text-xl lg:text-black">
